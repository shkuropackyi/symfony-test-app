...
class PricingPlan
{
    ...
    #[ORM\ManyToMany(targetEntity: PricingPlanFuture::class)]
    ...
    /**
     * @return Collection<int, PricingPlanFuture>
     */
    ...
    public function addFeature(PricingPlanFuture $feature): self
    {
    ...
    public function removeFeature(PricingPlanFuture $feature): self
    {
